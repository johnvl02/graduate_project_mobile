...
public class RequestsForFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View root = inflater.inflate(R.layout.fragment_requests_for, container, false);
        layout = root.findViewById(R.id.layout2);
        getRequest();
    ...
    private void getRequest(){
        ...
        stringBuilder.append("http://10.0.2.2:8080/android/requestCar?token=").append(token);
            ...
            try {
                ...
                for (int i=0;i<len;i++){
                    ...
                    btn.setOnClickListener(v -> {
                        ...
                        fragmentTransaction.hide(RequestsForFragment.this);
                        fragmentTransaction.commit();
                        ((MainActivity) getActivity()).navigateTo(R.id.nav_requestsForCar);
                    });
                    layout.addView(view);
                }
